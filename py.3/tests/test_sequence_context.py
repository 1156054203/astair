...
class SequenceSearchOutputTest(unittest.TestCase):
    ...
    def test_ahocorasick_search_CHH_top(self):
        ...
        ahocorasick_search('CHH', contexts, 'AACTTCATCACT', 'test_string', None, data_context, context_total_counts, None)
    ...
    def test_ahocorasick_search_CHH_bottom(self):
        ...
        context_total_counts = defaultdict(int)
        contexts, all_keys = sequence_context_set_creation('CHH', None)
        ahocorasick_search('CHHb', contexts, 'AAGGCTTTGccc', 'test_string', None, data_context, context_total_counts, None)
    ...
    def test_ahocorasick_search_CHG_top(self):
        ...
        ahocorasick_search('CHG', contexts, 'AACTTCAGCACT', 'test_string', None, data_context, context_total_counts, None)
    ...
    def test_ahocorasick_search_CHG_bottom(self):
        ...
        context_total_counts = defaultdict(int)
        contexts, all_keys = sequence_context_set_creation('CHG', None)
        ahocorasick_search('CHGb', contexts, 'AACTTCAGCACT', 'test_string', None, data_context, context_total_counts, None)
