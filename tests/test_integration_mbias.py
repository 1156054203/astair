...
class MbiasOutputTest(unittest.TestCase):
    ...
    def test_mbias_default_taps(self):
        ...
        self.assertEqual(data_generated,[('#POSITION_(bp)', 'MOD_LVL_CpG_READ_1'), ('1', '100.0'), ('2', '100.0'), ('3', '71.429'), ('4', '52.941'), ('5', '100.0'), ('6', '66.667'), ('7', '33.333'), ('8', '100.0'), ('9', '100.0'), ('10', '100.0'), ('11', '100.0'), ('12', '100.0'), ('13', '100.0'), ('14', '100.0'), ('15', '100.0'), ('16', '100.0'), ('17', '100.0'), ('18', '100.0'), ('19', '100.0'), ('20', '100.0'), ('21', '100.0'), ('22', '100.0'), ('23', '95.0'), ('24', '100.0'), ('25', '100.0'), ('26', '88.889'), ('27', '100.0'), ('28', '100.0'), ('29', '100.0'), ('30', '100.0'), ('31', '100.0'), ('32', '100.0'), ('33', '100.0'), ('34', '100.0'), ('35', '100.0'), ('36', '100.0'), ('37', '100.0'), ('38', '100.0'), ('39', '100.0'), ('40', '100.0'), ('41', '87.5'), ('42', '100.0'), ('43', '97.368'), ('44', '100.0'), ('45', '100.0'), ('46', '100.0'), ('47', '100.0'), ('48', '100.0'), ('49', '87.5'), ('50', '100.0'), ('51', '100.0'), ('52', '100.0'), ('53', '100.0'), ('54', '100.0'), ('55', '100.0'), ('56', '100.0'), ('57', '100.0'), ('58', '100.0'), ('59', '100.0'), ('60', '100.0'), ('61', '100.0'), ('62', '100.0'), ('63', '100.0'), ('64', '100.0'), ('65', '100.0'), ('66', '100.0'), ('67', '100.0'), ('68', '100.0'), ('69', '100.0'), ('70', '100.0'), ('71', '100.0'), ('72', '100.0'), ('73', '100.0'), ('74', '90.0'), ('75', '100.0'), ('76', '100.0'), ('77', '100.0'), ('78', '100.0'), ('79', '100.0'), ('80', '100.0')])
    ...
    def test_mbias_default_wgbs(self):
        ...
        with open(current + '/test_data/small_real_wgbs_lambda_CtoT_Mbias.txt','r') as call_file:
            ...
            for row in mod_reader:
                data_generated.append(tuple((row)[0:2]))
        self.assertEqual(data_generated[-10:-1], [('71', '100.0'), ('72', '100.0'), ('73', '100.0'), ('74', '100.0'), ('75', '66.667'), ('76', '100.0'), ('77', '100.0'), ('78', '100.0'), ('79', '100.0')])
