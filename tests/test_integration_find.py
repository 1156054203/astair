...
class FindOutputTest(unittest.TestCase):
    ...
    def test_find_default_all(self):
        ...
        self.assertEqual(data_generated[0:20], [('CHROM', 'START', 'END', 'SPECIFIC_CONTEXT', 'CONTEXT'), ('lambda', '2', '3', 'CCC', 'CHH'), ('lambda', '3', '4', 'CGG', 'CpG'), ('lambda', '4', '5', 'CGC', 'CpG'), ('lambda', '5', '6', 'CCG', 'CHG'), ('lambda', '6', '7', 'CGA', 'CpG'), ('lambda', '7', '8', 'CGC', 'CpG'), ('lambda', '9', '10', 'CCT', 'CHH'), ('lambda', '10', '11', 'CTC', 'CHH'), ('lambda', '12', '13', 'CGC', 'CpG'), ('lambda', '13', '14', 'CGA', 'CpG'), ('lambda', '14', '15', 'CGG', 'CpG'), ('lambda', '15', '16', 'CGC', 'CpG'), ('lambda', '16', '17', 'CCG', 'CHG'), ('lambda', '17', '18', 'CCC', 'CHH'), ('lambda', '22', '23', 'CGC', 'CpG'), ('lambda', '23', '24', 'CGA', 'CpG'), ('lambda', '24', '25', 'CTA', 'CHH'), ('lambda', '32', '33', 'CAT', 'CHH'), ('lambda', '41', '42', 'CCG', 'CHG')])
