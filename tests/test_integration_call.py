...
class CallOutputTest(unittest.TestCase):
    ...
    def test_call_default_taps(self):
        ...
        cytosine_modification_finder(current + '/test_data/small_lambda.bam', current + '/test_data/lambda_phage.fa', 'all', False, False, 13, None, 'mCtoT', 0, 0, True, True, True, False, True, True, 250, None, 1, current + '/test_data/', False)
        data_generated = list()
    ...
    def test_call_default_wgbs(self):
        ...
        the expected one by context."""
        cytosine_modification_finder(current + '/test_data/small_lambda.bam', current + '/test_data/lambda_phage.fa', 'all', False, False, 13, None, 'CtoT', 0, 0, True, True, True, False, True, True, 250, None, 1, current + '/test_data/', False)
        data_generated = list()
