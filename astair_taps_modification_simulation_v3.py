...
@click.option('library', '--library', '-lb',  type=click.Choice(['directional', 'ptat']), default='directional', required=False, help='Provide the correct library construction method.')
